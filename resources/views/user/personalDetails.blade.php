...
@section('content')
    <div class="container-fluid d-flex flex-row h-100" >
        ...
        <div class="d-flex flex-column m-5 w-50">
            <h1>Personal Details</h1> {{-- User menu personal details page --}}
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="row g-0">
                            ...
                            <div class="col-md-8"> {{-- Logged in users current details --}}
                    ...
                    <div class="col-6 d-flex flex-column">
                        <div class="m-2 d-flex justify-content-end">
                            <a class="btn secondary-btn w-50" href="/user/personaldetails/changeaddress" role="button"> {{-- Redirect to edit address page --}}
                                    Change address
                            </a>
                        </div>
                        <div class="m-2 d-flex justify-content-end">
                            <a class="btn secondary-btn w-50" href="/user/personaldetails/changepassword" role="button"> {{-- Redirect to edit password page --}}
                                    Change password 
                            </a>
                        </div>
                    </div>
            ...
            <div class="card bg-light">
                ...
                <form class="m-2 px-3" method="POST" action="/user/personaldetails"> {{-- Form to edit basic personal details for logged in user --}}
